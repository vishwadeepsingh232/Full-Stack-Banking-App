...
public class User {
    ...
    @Id
    private int user_id;
    @NotEmpty(message = "The First name field annot be empty")
    @Size(min = 3,message = "The first name field must greater than 3 characters")
    private String first_name;
    @NotEmpty(message = "The Last name field annot be empty")
    @Size(min = 3,message = "The last name field must greater than 3 characters")
    private String last_name;
    @Email
    @NotEmpty
    @Pattern(regexp = "([a-zA-Z0-9]+(?:[._+-][a-zA-Z0-9]+)*)@([a-zA-Z0-9]+(?:[.-][a-zA-Z0-9]+)*[.][a-zA-Z]{2,})",message = "Please enter a valid e-mail")
